...
Walking `notes/2026-06-12-spec-review-findings.md` finding-by-finding (user chose to review every item, fork or not; Q&A batches of ≤4). Status: **#1–#10b decided, #18 + new #34 decided, #10c MOOT (inversion parked to v2 — section below), #11–#17/#19–#33 not yet walked.** Section A is unblocked — batch 1 ready to apply (no #10c edit).
