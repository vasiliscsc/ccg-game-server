...
## Spec-review fix pass (session 10–11, 2026-06-12→14 — BATCH 1 ✅ APPLIED to spec 2026-06-14, session 11; walk of #11–#33 still pending)

Walking `notes/2026-06-12-spec-review-findings.md` finding-by-finding (user chose to review every item, fork or not; Q&A batches of ≤4). Status: **#1–#10b + #18 + #34 ✅ APPLIED to the spec (session 11, 2026-06-14); #10c MOOT (inversion parked to v2 — section below); #11–#17/#19–#33 not yet walked.** Batch 1 grep-verified clean (no stale `isDamaged`/`SourceMinionId`/`MinionDamagedEvent`/`DeathrattleAction`/"hero-power damage"/"damaged enemy"/③ "is alive"/⑦ "④–⑥").
